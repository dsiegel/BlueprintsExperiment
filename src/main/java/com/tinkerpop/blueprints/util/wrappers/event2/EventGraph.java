...
import com.tinkerpop.blueprints.util.wrappers.event2.listener.EdgeAddedEvent;
import com.tinkerpop.blueprints.util.wrappers.event2.listener.EdgeRemovedEvent;
import com.tinkerpop.blueprints.util.wrappers.event2.listener.GraphChangedListener;
import com.tinkerpop.blueprints.util.wrappers.event2.listener.VertexAddedEvent;
import com.tinkerpop.blueprints.util.wrappers.event2.listener.VertexRemovedEvent;
...
public class EventGraph<T extends Graph> implements Graph, WrapperGraph<T> {
    ...
    public Iterable<Edge> getEdges() {
        return new com.tinkerpop.blueprints.util.wrappers.event2.EventEdgeIterable(this.baseGraph.getEdges(), this);
    }

    public Iterable<Edge> getEdges(final String key, final Object value) {
        return new com.tinkerpop.blueprints.util.wrappers.event2.EventEdgeIterable(this.baseGraph.getEdges(key, value), this);
    }
