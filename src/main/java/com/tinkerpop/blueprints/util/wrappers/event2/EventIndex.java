...
public class EventIndex<T extends Element> implements Index<T> {
    ...
    public void remove(final String key, final Object value, final T element) {
        this.rawIndex.remove(key, value, (T) ((com.tinkerpop.blueprints.util.wrappers.event2.EventElement) element).getBaseElement());
    }

    public void put(final String key, final Object value, final T element) {
        this.rawIndex.put(key, value, (T) ((com.tinkerpop.blueprints.util.wrappers.event2.EventElement) element).getBaseElement());
    }
    ...
    public CloseableIterable<T> get(final String key, final Object value) {
        if (Vertex.class.isAssignableFrom(this.getIndexClass())) {
            ...
            return (CloseableIterable<T>) new com.tinkerpop.blueprints.util.wrappers.event2.EventEdgeIterable((Iterable<Edge>) this.rawIndex.get(key, value), this.eventGraph);
        }
    }
    ...
    public CloseableIterable<T> query(final String key, final Object query) {
        if (Vertex.class.isAssignableFrom(this.getIndexClass())) {
            ...
            return (CloseableIterable<T>) new com.tinkerpop.blueprints.util.wrappers.event2.EventEdgeIterable((Iterable<Edge>) this.rawIndex.query(key, query), this.eventGraph);
        }
    }
